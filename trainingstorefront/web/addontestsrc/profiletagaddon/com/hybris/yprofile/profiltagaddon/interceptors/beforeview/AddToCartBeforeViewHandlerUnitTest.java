...
public class AddToCartBeforeViewHandlerUnitTest {
    ...
    @Test
    public void shouldAddCategoriesToAddToCartModel()
    {
        ...
        when(productFacade.getProductForCodeAndOptions(eq(PRODUCT_CODE), eq(Collections.singleton(ProductOption.CATEGORIES))))
