...
/**
 * Test class for testing the functionality of the AbandonedCartMailNotificationJob.
 *
 */
@IntegrationTest
public class AbandonedCartMailNotificationJobTest extends ServicelayerTransactionalTest
{
	private static final Logger LOG = Logger.getLogger(AbandonedCartMailNotificationJobTest.class);
	...
	@Resource
	private AbandonedCartMailNotificationJob abandonedCartMailNotificationJob;
	...
	@Test
	public void testAbandonedCartMailNotificationJob()
	{
		final PerformResult result = abandonedCartMailNotificationJob.perform(cartRemovalCronJobModel);
	 ...
	 */
	@Test
	public void testAbandonedCartMaxAgeMailNotificationJob() throws InterruptedException
	{
		final UserModel user = this.createTestUser("testUser1");
		CartModel cart = getCartForUser(user);
	...
	private void setupTestDataEnvironment() throws ImpExException
	{
		if (!initialized)
		{
			importCsv("/acceleratorservices/test/testAbandonedCartMailNotificationJob.impex", "utf-8");
